...
public class SRSMinoStyle extends MinoStyle {
    ...
    static {
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/blue.png");
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/cyan.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/lock.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/green.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/orange.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/purple.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/red.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        temp = null;
        try {
            temp = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/yellow.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    private Image getScaledMino(int color, int size) {
        ...
        if(imageCache[color - 1].containsKey(size)) {
            ...
            try {
                ...
                switch(color) {
                    case BLUE:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/blue.png");
                        break;
                    case CYAN:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/cyan.png");
                        break;
                    case GREEN:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/green.png");
                        break;
                    case GREY:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/lock.png");
                        break;
                    case ORANGE:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/orange.png");
                        break;
                    case PURPLE:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/purple.png");
                        break;
                    case RED:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/red.png");
                        break;
                    case YELLOW:
                        file = TetrisUtils.getResource("/com/github/leftisttachyon/tetris/resources/srs/yellow.png");
                        break;
                    default:
                        return null;
                }
